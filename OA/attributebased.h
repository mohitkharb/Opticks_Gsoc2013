#ifndef ATTRIBUTEBASED_H
#define ATTRIBUTEBASED_H
...
class AttributeBased : public QWidget
{
    Q_OBJECT
    
public:
    explicit AttributeBased(int row,int col,int **labels1,int ***data1,Image i1,int num_band,int f,QWidget *parent = 0);
    ~AttributeBased();
